...
/**
 * Reference to an element in the CByteArray
 */
class CByteReference {
...
public:
    ...
    CByteReference& operator=(uint64_t);
...
/**
 * Iterate over all elements in the CByteArray
 */
class CByteIterator {
public:
...
public:
     ...
     */
    uint64_t get_value_at(size_t index) const;
